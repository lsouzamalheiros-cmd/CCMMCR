...
st.set_page_config(page_title="Sistema Escolar - CCMMR by Leandro Malheiros V2.0.3 ", layout="centered")
...
@st.cache_resource
def conectar():
    uri = "mongodb+srv://lsouzamalheiros_db_user:malheiros76@cluster0.wc4y62s.mongodb.net/"
...
👨‍🏫 Escola [CCM Marechal Rondon]
📞 Contato: [45 3254-0521]
...
def exportar_ocorrencias_para_pdf(ocorrencias, nome_arquivo):
    ...
    elementos.append(Paragraph(
        "<b>COLÉGIO CÍVICO MILITAR MARECHAL RONDON</b>",
        cabecalho_style
    ))
